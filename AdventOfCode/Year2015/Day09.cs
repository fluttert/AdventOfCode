...
namespace AdventOfCode.Year2015
{
    public class Day09 : IAoC
    {
        ...
        {
            return CalculateDistances(input, true);
        }

        public string SolvePart2(string input)
        {
            return CalculateDistances(input, false);
        }

        internal string CalculateDistances(string input, bool shortest = true)
        {
            ...
            return shortest ? shortestDistance.ToString() : longestDistance.ToString();
        }
